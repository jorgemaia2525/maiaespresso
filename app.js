...
window.handleCardTilt = function(e, card) {
  ...
  card.style.transform = `perspective(800px) rotateX(${rotateX.toFixed(2)}deg) rotateY(${rotateY.toFixed(2)}deg) scale3d(1.06, 1.06, 1.06)`;
  card.style.boxShadow = `${-rotateY * 2.5}px ${rotateX * 2.5 + 25}px 50px rgba(0,0,0,0.8)`;
};
...
if (document.readyState === 'loading') {
  ...
  setTimeout(init3DTiltAndScrollReveal, 50);
}
